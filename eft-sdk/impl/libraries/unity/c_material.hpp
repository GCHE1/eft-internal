...
public:
	auto get_shader( ) -> unity::c_shader* {
		MONO_METHOD( get_shader_fn, ( "UnityEngine::Material.get_shader()" ), -1, unity::c_shader * ( * )( void* ) );
	...
	auto set_float( managed_system::c_string prop, float value ) -> void
	{
		MONO_METHOD( set_float_fn, ( "UnityEngine::Material.SetFloat()" ), -1, void( * )( void *, managed_system::c_string, float ) );
		return set_float_fn( this, prop, value );
	}

	auto set_int( managed_system::c_string prop, int value ) -> void {
		MONO_METHOD( set_int_fn, ( "UnityEngine::Material.SetInt()" ), -1, void( * )( void*, managed_system::c_string, int ) );
		return set_int_fn( this, prop, value );
	}

	template<typename t>
	auto set_color( managed_system::c_string prop, t color ) -> void {
		MONO_METHOD( set_color_fn, ( "UnityEngine::Material.SetColor()" ), -1, void( * )( void*, managed_system::c_string, t ) );
		return set_color_fn( this, prop, color );
	}

	auto set_texture( managed_system::c_string prop, std::uintptr_t texture ) -> void {
		MONO_METHOD( set_texture_fn, ( "UnityEngine::Material.SetTexture()" ), 2, void( * )( void*, managed_system::c_string, std::uintptr_t ) );
