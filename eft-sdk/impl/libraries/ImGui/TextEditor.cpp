...
void TextEditor::SetShowDefines(bool aValue)
{
	mShowDefines = aValue;
}
			...
			if (!line.empty())
			{
				...
				else
				{
					...
					else
					{
						...
						if (i.mColumn + 1 >= (int)endStr.size() && equals(endStr.begin(), endStr.end(), from + 1 - endStr.size(), from + 1, pred))
							commentStart = end;
					}
				}
			}
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::CPlusPlus()
{
	...
	if (!inited)
	{
		...
		static const char *const identifiers[] = {
			...
			"ispunct", "isspace", "isupper", "kbhit", "zlog10", "zlog2", "zlog", "memcmp", "modf", "pow", "zlog", "sprintf", "snprintf", "putchar", "putenv", "puts", "rand", "remove", "rename", "sinh", "sqrt", "srand", "strcat", "strcmp", "strerror", "time", "tolower", "toupper",
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::HLSL()
{
	...
	if (!inited)
	{
		...
		static const char *const identifiers[] = {
			...
			"ldexp", "length", "lerp", "lit", "zlog", "zlog10", "zlog2", "mad", "max", "min", "modf", "msad4", "mul", "noise", "normalize", "pow", "zlog",
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::GLSL()
{
	...
	if (!inited)
	{
		...
		static const char *const identifiers[] = {
			"abort", "abs", "acos", "asin", "atan", "atexit", "atof", "atoi", "atol", "ceil", "clock", "cosh", "ctime", "div", "exit", "fabs", "floor", "fmod", "getchar", "getenv", "isalnum", "isalpha", "isdigit", "isgraph",
			"ispunct", "isspace", "isupper", "kbhit", "zlog10", "zlog2", "zlog", "memcmp", "modf", "pow", "putchar", "putenv", "puts", "rand", "remove", "rename", "sinh", "sqrt", "srand", "strcat", "strcmp", "strerror", "time", "tolower", "toupper"
		};
		for (auto& k : identifiers)
		{
			Identifier id;
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::SQL()
{
	...
	if (!inited)
	{
		...
		static const char *const identifiers[] = {
			...
			"LENGTHB",  "LENGTHC",  "LISTAGG",  "LN",  "LNNVL",  "LOCALTIMESTAMP",  "zlog",  "LOWER",  "LPAD",  "LTRIM",  "MAX",  "MEDIAN",  "MIN",  "MOD",  "MONTHS_BETWEEN",  "NANVL",  "NCHR",
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::AngelScript()
{
	...
	if (!inited)
	{
		...
		static const char *const identifiers[] = {
			"cos", "sin", "tab", "acos", "asin", "atan", "atan2", "cosh", "sinh", "tanh", "zlog", "zlog10", "pow", "sqrt", "abs", "ceil", "floor", "fraction", "closeTo", "fpFromIEEE", "fpToIEEE",
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Lua()
{
	...
	if (!inited)
	{
		...
		static const char *const identifiers[] = {
			...
			"floor", "fmod", "ult", "zlog", "max", "min", "modf", "rad", "random", "randomseed", "sin", "sqrt", "string", "tan", "type", "atan2", "cosh", "sinh", "tanh",
			 "pow", "frexp", "ldexp", "zlog10", "pi", "huge", "maxinteger", "mininteger", "loadlib", "searchpath", "seeall", "preload", "cpath", "path", "searchers", "loaded", "module", "require", "clock",
